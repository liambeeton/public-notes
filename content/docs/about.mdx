---
title: About Liam Beeton
description: Learn about Liam Beeton, a software developer in South Africa writing about software, AI, cybersecurity, photography, trail running, mountain biking, and family life.
---
...
I'm Liam Beeton. I'm a [software developer](https://www.linkedin.com/in/liambeeton) and my partner
and I have two boys; the youngest is {new Date().getFullYear() - 2021} and the eldest is {new Date().getFullYear() - 2019}. So
...
- [Mac Setup for Web Development](/mac-setup-web-development) if you want a concrete look at my development environment
- [gRPC over mTLS in Go](/grpc-mtls-go) if you are here for backend and Go security notes
- [OpenClaw Multi-Agent Orchestration](/openclaw-multi-agent-orchestration) if you are exploring AI systems and agent design
- [Job Interview Questions](/job-interview-questions) if you are navigating software career decisions
