...
<Callout type="warn" title="Run this on a fresh machine">
...
<Callout type="info" title="Raycast shortcut">
...
<Callout type="warn" title="Save your passphrase first">
...
<Callout type="idea" title="Why Volta over nvm?">
